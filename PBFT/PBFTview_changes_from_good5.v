...
Section PBFTview_changes_from_good5.
  ...
  Lemma sent_view_change_is_in_log :
    forall (eo : EventOrdering) (e : Event) vc dst st i,
      loc e = PBFTreplica i
      ...
      -> own_view_change_in_log vc (view_change_state st)
         /\ vc = mk_current_view_change i (current_view st) st.
  Proof.
  ...
  Qed.
  Hint Resolve sent_view_change_is_in_log : pbft.

End PBFTview_changes_from_good5.
