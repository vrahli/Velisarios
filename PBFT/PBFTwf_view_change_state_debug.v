...
(*  Lemma implies_wf_view_change_state_update_low_water_mark :
  ...
  Lemma wf_view_change_state_preserved_on_event :
    forall (eo  : EventOrdering)
      ...
      -> wf_view_change_state (view_change_state st).
  Proof.
    prove_by_ind ind h eqst sop p trig smash_handlers4 smash_pbft_ind6_10.
  Qed.
  ...
  Proof.
    ...
    pose proof (ite_first_state_sm_on_event_as_before (PBFTreplicaSM slf) eo e) as q.

    remember (state_sm_on_event (PBFTreplicaSM slf) eo (local_pred e)) as stsm.
    symmetry in Heqstsm.
