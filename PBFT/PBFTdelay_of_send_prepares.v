...
Section PBFTdelay_of_send_prepares.
  ...
  Lemma delay_of_send_prepares :
    forall (eo : EventOrdering) (e : Event) p dst delay,
      In (MkDMsg (PBFTprepare p) dst delay) (output_system_on_event_ldata PBFTsys e)
      -> delay = 0.
  Proof.
    introv j.
  ...
  Lemma send_prepare_no_delay :
    forall (eo : EventOrdering) (e : Event) p dst delay,
      In (MkDMsg (PBFTprepare p) dst delay) (output_system_on_event_ldata PBFTsys e)
      -> In (send_prepare p dst) (output_system_on_event_ldata PBFTsys e).
  Proof.
    introv i.
    applydup delay_of_send_prepares in i; subst; auto.
  Qed.

End PBFTdelay_of_send_prepares.
