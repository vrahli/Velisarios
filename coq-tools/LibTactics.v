...
Notation "'exists' x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 ',' P" :=
  ...
  (at level 200, x1 ident, x2 ident, x3 ident, x4 ident, x5 ident,
   ...
   right associativity) : type_scope.  
Notation "'exists' x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 ',' P" :=
  (exists x1, exists x2, exists x3, exists x4, exists x5, exists x6, 
   exists x7, exists x8, exists x9, exists x10, exists x11, P)
  (at level 200, x1 ident, x2 ident, x3 ident, x4 ident, x5 ident,
   x6 ident, x7 ident, x8 ident, x9 ident, x10 ident, x11 ident,
   right associativity) : type_scope.  
Notation "'exists' x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 ',' P" :=
  (exists x1, exists x2, exists x3, exists x4, exists x5, exists x6, 
   exists x7, exists x8, exists x9, exists x10, exists x11, exists x12, P)
  (at level 200, x1 ident, x2 ident, x3 ident, x4 ident, x5 ident,
   x6 ident, x7 ident, x8 ident, x9 ident, x10 ident, x11 ident, x12 ident,
   right associativity) : type_scope.  
Notation "'exists' x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 ',' P" :=
  (exists x1, exists x2, exists x3, exists x4, exists x5, exists x6, 
   exists x7, exists x8, exists x9, exists x10, exists x11, exists x12, exists x13, P)
  (at level 200, x1 ident, x2 ident, x3 ident, x4 ident, x5 ident,
   x6 ident, x7 ident, x8 ident, x9 ident, x10 ident, x11 ident, x12 ident, x13 ident,
   right associativity) : type_scope.  
Notation "'exists' x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 ',' P" :=
  (exists x1, exists x2, exists x3, exists x4, exists x5, exists x6, 
   exists x7, exists x8, exists x9, exists x10, exists x11, exists x12, exists x13, exists x14, P)
  (at level 200, x1 ident, x2 ident, x3 ident, x4 ident, x5 ident,
   x6 ident, x7 ident, x8 ident, x9 ident, x10 ident, x11 ident, x12 ident, x13 ident, x14 ident,
   right associativity) : type_scope.  
Notation "'exists' x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15 ',' P" :=
  (exists x1, exists x2, exists x3, exists x4, exists x5, exists x6, 
   exists x7, exists x8, exists x9, exists x10, exists x11, exists x12, exists x13, exists x14, exists x15, P)
  (at level 200, x1 ident, x2 ident, x3 ident, x4 ident, x5 ident,
   x6 ident, x7 ident, x8 ident, x9 ident, x10 ident, x11 ident, x12 ident, x13 ident, x14 ident, x15 ident,
   right associativity) : type_scope.  
...
Ltac get_term_existential_arity T :=
  match T with
  | exists x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14 x15, _ => constr:(15)
  | exists x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13 x14, _ => constr:(14)
  | exists x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12 x13, _ => constr:(13)
  | exists x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11 x12, _ => constr:(12)
  | exists x1 x2 x3 x4 x5 x6 x7 x8 x9 x10 x11, _ => constr:(11)
  | exists x1 x2 x3 x4 x5 x6 x7 x8 x9 x10, _ => constr:(10)
  | exists x1 x2 x3 x4 x5 x6 x7 x8 x9, _ => constr:(9)
...
(* =10= *)
Tactic Notation "exists" constr(T1) constr(T2) constr(T3) constr(T4)
 constr(T5) constr(T6) constr(T7) constr(T8) constr(T9) constr(T10):=
  exists T1; exists T2; exists T3; exists T4; exists T5; exists T6; exists T7; exists T8; exists T9; exists T10.
(* =11= *)
Tactic Notation "exists" constr(T1) constr(T2) constr(T3) constr(T4)
 constr(T5) constr(T6) constr(T7) constr(T8) constr(T9) constr(T10) constr(T11) :=
  exists T1; exists T2; exists T3; exists T4; exists T5; exists T6; exists T7; exists T8; exists T9; exists T10; exists T11.
(* =12= *)
Tactic Notation "exists" constr(T1) constr(T2) constr(T3) constr(T4)
 constr(T5) constr(T6) constr(T7) constr(T8) constr(T9) constr(T10) constr(T11) constr(T12) :=
  exists T1; exists T2; exists T3; exists T4; exists T5; exists T6; exists T7; exists T8; exists T9; exists T10; exists T11; exists T12.
(* =13= *)
Tactic Notation "exists" constr(T1) constr(T2) constr(T3) constr(T4)
 constr(T5) constr(T6) constr(T7) constr(T8) constr(T9) constr(T10) constr(T11) constr(T12) constr(T13) :=
  exists T1; exists T2; exists T3; exists T4; exists T5; exists T6; exists T7; exists T8; exists T9; exists T10; exists T11; exists T12; exists T13.
(* =14= *)
Tactic Notation "exists" constr(T1) constr(T2) constr(T3) constr(T4)
 constr(T5) constr(T6) constr(T7) constr(T8) constr(T9) constr(T10) constr(T11) constr(T12) constr(T13) constr(T14) :=
  exists T1; exists T2; exists T3; exists T4; exists T5; exists T6; exists T7; exists T8; exists T9; exists T10; exists T11; exists T12; exists T13; exists T14.
(* =15= *)
Tactic Notation "exists" constr(T1) constr(T2) constr(T3) constr(T4)
 constr(T5) constr(T6) constr(T7) constr(T8) constr(T9) constr(T10) constr(T11) constr(T12) constr(T13) constr(T14) constr(T15) :=
  exists T1; exists T2; exists T3; exists T4; exists T5; exists T6; exists T7; exists T8; exists T9; exists T10; exists T11; exists T12; exists T13; exists T14; exists T15.
