  ...
  Class EventOrdering :=
    {
      ...
      trigger     : Event -> msg;              (* Each event is triggered the receipt of a message *)
...
(*  Definition isCrashed (e : Event) : Prop :=
  ...
  Proof.
    introv xx; unfold isByz; rewrite xx; intro zz; inversion zz.
  Qed.
  ...
  Notation "a ≼ b" := (causalOrderLe a b) (at level 0).
  ...
  Notation "a ⊑ b" := (localCausalOrderLe a b) (at level 0).
  ...
  Qed.
  Hint Resolve localCausalOrderLe_refl : eo.
  ...
  Lemma localCausalOrder_if_isFirst :
    forall e1 e2,
      ...
      -> e1 ⊏ e2.
  Proof.
    intro e1; induction e2 as [e2 ind] using predCausalOrderInd; introv eqloc isf de.
  ...
  Lemma tri_if_same_loc :
    forall e1 e2,
      ...
      -> (e1 ⊏ e2 \/ e1 = e2 \/ e2 ⊏ e1).
  Proof.
    induction e1 as [e1 ind] using predCausalOrderInd; introv eqloc.
    ...
    - clear ind.
      ...
      left.
      apply localCausalOrder_if_isFirst; auto.
  ...
  Proof.
    ...
    - destruct (subEventOrdering_causalLe_loc_dec e e'); auto.
      ...
      + right; intro h.
        unfold subEventOrdering_cond in h.
        autodimp h hyp.
  ...
  Proof.
    introv.
    unfold subEventOrdering_causalOrder.
    introv.
 ...
 Lemma get_first_get_first_eq :
...

    {
...

      {
...

        {
          ...
          apply causalOrderLe_implies_eq in h; auto; subst.
          f_equal; apply UIP_dec; apply bool_dec.
        }
  ...
  Proof.
    (*exists
      (subEventOrdering_type e)
      (subEventOrdering_causalOrder e)
  ...
  Proof.
    ...
    autodimp q0 hyp; repnd.
    repndors; exrepnd.

    - exists e' dst m0; dands; auto.
...
Notation "a ≺ b" := (causalOrder a b) (at level 0) : eo.
Notation "a ≼ b" := (causalOrderLe a b) (at level 0) : eo.
Notation "a ⊏ b" := (localCausalOrder a b) (at level 0) : eo.
Notation "a ⊑ b" := (localCausalOrderLe a b) (at level 0) : eo.
